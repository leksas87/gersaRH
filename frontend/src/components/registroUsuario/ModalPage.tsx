			...
			>
				<div className="modal-dialog modal-dialog-centered"  >
					<div className="modal-content mdl-content">
						...
						<div className="flex-container justify-content-start modal-header">
							<div>
							<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-person-plus-fill icon-modal" viewBox="0 0 16 16">
						...
						<div 
							className="modal-body justify-content-start flex-container"
						>
							<form>
								<div className="mb-3">
									<label 
										htmlFor="recipient-name" 
										className="col-form-label inputLabel"
									>
										Numero de empleado*
									</label>
									<input 
						...
						<div className="modal-footer">
							<button 
								className='btn btn-primary mt-4 shadow-sm inputSubmitmodal'
							>
								Guardar empleado
							</button>
						</div>
