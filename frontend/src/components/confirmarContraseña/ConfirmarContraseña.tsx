...
export const ConfirmarContraseña = () => {
    ...
    const isFormValid = (): boolean => {
		...
		if (
			contraseña1.trim().length === 0 ||
			contraseña2.trim().length === 0 
		) {
			setError('Contraseña requerida');
			return false;
		} else if (
			contraseña1.trim().length < 6 || contraseña2.trim().length < 6
		) {
        ...
        <div className="containerProject custm-body-cc d-flex justify-content-center align-items-center">
            <div className="custm-shadow-cc">
                ...
                >
                    ...
                    >
                        <h1 
                            className='textColorSecondary fs-3 custm-title-cc  ' 
                        >
                        ...
                        >
                            ...
                            <button 
                                ...
                                onClick={() => {
                                    isFormValid() ? console.log(contraseña1,contraseña2) 
                                                : console.log("Aun no")
