...
const ModalNuevoArchivoEmpleadoEmpresa = () => {
		...
		<>
			<div>
				...
				<button
					...
					data-bs-target='#modalNuevoArchivoEmpleadoEmpresa'
				>
					+ Nuevo
				</button>
				...
				<div
					...
					id='modalNuevoArchivoEmpleadoEmpresa'
					tabIndex={-1}
					aria-labelledby='modalNuevoArchivoEmpleadoEmpresa'
					aria-hidden='true'
				>
...
export default ModalNuevoArchivoEmpleadoEmpresa;
